    ...
    <header class="default sticky-header" id="main-header">
        <div class="container">
            <div class="sixteen columns">
                ...
                <!-- Logo -->
                <div id="logo">
                    <a href="https://workscout.in/" title="WorkScout" rel="home"><img
                ...
                <nav id="navigation" class="menu">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-2884"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2884"><a
                                        href="https://workscout.in/submit-resume/">Submit Resume</a></li>
                            ...
                            <ul class="sub-menu">
                                ...
                                <li id="menu-item-2888"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2888"><a
                                        href="https://workscout.in/post-a-job/">Post a Job</a></li>
                                <li id="menu-item-2887"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2887"><a
                                        href="https://workscout.in/job-dashboard/">Employer Dashboard</a></li>
                            </ul>
                        </li>
                    ...
                    <ul class="float-right">
                        <li>
                            <a href="https://workscout.in/candidate-dashboard/"><i class="fa fa-sign-out"></i> User Page</a>
                        </li>
                        <li>
                            <a href="https://workscout.in/wp-login.php?action=logout&amp;redirect_to=https%3A%2F%2Fworkscout.in&amp;_wpnonce=cc94b1722c"><i
        ...
        <article id="post-14" class="sixteen columns woocommerce-account post-14 page type-page status-publish hentry">
            ...
            <nav class="woocommerce-MyAccount-navigation">
                <ul>
                    ...
                    <li class="">
                        <a href="https://workscout.in/my-account/">Dashboard</a>
                    </li>
                    <li class="">
                    ...
                    <li class="">
                        <a href="https://workscout.in/my-account/customer-logout/">Logout</a>
                    </li>
                </ul>
            </nav>
