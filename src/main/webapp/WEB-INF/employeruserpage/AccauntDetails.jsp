...
<head>
    ...
    <title>My Account &#8211; WorkScout</title>
    ...
    <link rel='stylesheet' id='select2-css'
          href='https://39sf152pf74z2negmt1gi8ik-wpengine.netdna-ssl.com/wp-content/plugins/woocommerce/assets/css/select2.css'
          type='text/css' media='all'/>
    ...
    <script type='text/javascript'>
        /* <![CDATA[ */
        var _zxcvbnSettings = {"src": "https:\/\/workscout.in\/wp-includes\/js\/zxcvbn.min.js"};
        /* ]]> */
    </script>
    <script type='text/javascript'
            src='https://39sf152pf74z2negmt1gi8ik-wpengine.netdna-ssl.com/wp-includes/js/zxcvbn-async.min.js'></script>
    <script type='text/javascript'>
        /* <![CDATA[ */
        var wc_add_to_cart_params = {
            "ajax_url": "\/wp-admin\/admin-ajax.php",
            "wc_ajax_url": "\/my-account\/edit-account\/?wc-ajax=%%endpoint%%",
    ...
    <link rel="canonical" href="https://workscout.in/my-account/"/>
    <link rel='shortlink' href='https://workscout.in/?p=19'/>
    <link rel="alternate" type="application/json+oembed"
          href="https://workscout.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fworkscout.in%2Fmy-account%2F"/>
    <link rel="alternate" type="text/xml+oembed"
          href="https://workscout.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fworkscout.in%2Fmy-account%2F&#038;format=xml"/>
    <style type="text/css">
...
<body class="page-template-default page page-id-19 logged-in fullwidth woocommerce-account woocommerce-page woocommerce-edit-account group-blog workscout wpb-js-composer js-comp-ver-5.1 vc_responsive">
<div id="wrapper">
                ...
                <nav id="navigation" class="menu">
                    ...
                    <ul id="responsive" class="menu">
                            ...
                            <ul class="sub-menu">
                                <li id="menu-item-2889"
                                    class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2889"><a
                                        href="https://workscout.in/resumes/">Browse Candidates</a></li>
                                <li id="menu-item-2887"
                                    class="menu-item menu-item-type-post_type menu-item-object-page current-menu-item page_item page-item-2870 current_page_item menu-item-2887">
                                    <a href="https://workscout.in/job-dashboard/">Employer Dashboard</a></li>
                            </ul>
                        </li>
                        <li id="menu-item-2859"
                            ...
                            <%--<ul class="sub-menu">--%>
                            <%--<li id="menu-item-2882" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2882"><a href="https://workscout.in/browse-jobs/">Browse Jobs</a></li>--%>
                            <%--<li id="menu-item-8503" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-8503"><a href="https://workscout.in/browse-jobs-with-map/">Browse Jobs With Map</a></li>--%>
                            <%--<li id="menu-item-2883" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2883"><a href="https://workscout.in/browse-categories/">Browse Categories</a></li>--%>
                            <%--<li id="menu-item-2955" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2955"><a href="https://workscout.in/companies/">Browse Companies</a></li>--%>
                            <%--<li id="menu-item-2884" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2884"><a href="https://workscout.in/submit-resume/">Submit Resume</a></li>--%>
                            <%--<li id="menu-item-2885" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2885"><a href="https://workscout.in/candidate-dashboard/">Candidate Dashboard</a></li>--%>
                            <%--<li id="menu-item-2886" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2886"><a href="https://workscout.in/job-alerts/">Job Alerts</a></li>--%>
                            <%--<li id="menu-item-2891" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2891"><a href="https://workscout.in/my-bookmarks/">My Bookmarks</a></li>--%>
                            <%--</ul>--%>
                        </li>
                    ...
                    <ul class="float-right">
                        <li>
                            <a href="/my_accaunt/user_page_employer"><i class="fa fa-sign-out"></i> User Page</a>
                        </li>
                ...
                <nav id="breadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#">
                    <ul>
                        ...
                        <li class="current_item"><span property="itemListElement" typeof="ListItem"><span
                                property="name">My Account</span><meta property="position" content="2"></span></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="container full-width">
        <article id="post-19" class="sixteen columns post-19 page type-page status-publish hentry">
            <div class="woocommerce">
                <nav class="woocommerce-MyAccount-navigation">
                    <ul>
                        <li><a href="/my_accaunt/user_page_employer"> Employer Dashboard </a>
                        </li>
                        <li><a href="/my_accaunt/mybookmarks"> My Bookmarks </a></li>
                        <li class="">
                        </li>
                        <li class="">
                            <a href="/my_accaunt/address">Addresses</a>
                        </li>
                        <li class="">
                            <a href="/my_accaunt/accaunt_details">Account details</a>
                        </li>
                        <li class="">
                    ...
                    <form class="woocommerce-EditAccountForm edit-account" action="" method="post">
                        ...
                        <p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
                            ...
                            <input type="email" class="woocommerce-Input woocommerce-Input--email input-text"
                                   name="account_email" id="account_email" value="bvvb@mail.ru"/>
                        </p>
                        ...
                        <p>
                            <input type="hidden" id="_wpnonce" name="_wpnonce" value="be11820f16"/><input type="hidden"
...
<meta id="ba_s" property="options" content=""
      data-o="{&quot;tid&quot;:&quot;UA-43309925-3&quot;,&quot;co&quot;:{&quot;userId&quot;:7794},&quot;g&quot;:68456,&quot;dl&quot;:&quot;\\.avi|\\.doc|\\.exe|\\.gz|\\.mpg|\\.mp3|\\.pdf|\\.ppt|\\.psd|\\.rar|\\.wmv|\\.xls|\\.zip&quot;,&quot;s&quot;:0,&quot;a&quot;:0,&quot;d&quot;:{&quot;a&quot;:[2,&quot;purethemes&quot;],&quot;y&quot;:[4,2015],&quot;r&quot;:[5,&quot;employer&quot;],&quot;u&quot;:[6,7794]}}"/>
...
<script type='text/javascript'
        src='https://39sf152pf74z2negmt1gi8ik-wpengine.netdna-ssl.com/wp-content/plugins/woocommerce/assets/js/select2/select2.full.min.js'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
    var pwsL10n = {
...
<script type='text/javascript'
        src='https://39sf152pf74z2negmt1gi8ik-wpengine.netdna-ssl.com/wp-admin/js/password-strength-meter.min.js'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
...
<script type='text/javascript'
        src='https://39sf152pf74z2negmt1gi8ik-wpengine.netdna-ssl.com/wp-content/plugins/woocommerce/assets/js/frontend/password-strength-meter.min.js'></script>
<script type='text/javascript'
