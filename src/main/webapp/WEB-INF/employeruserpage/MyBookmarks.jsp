...
<head>
    ...
    <title>My Bookmarks &#8211; WorkScout</title>
    ...
    <script type='text/javascript'>
        ...
        var wc_add_to_cart_params = {
            ...
            "wc_ajax_url": "\/my-bookmarks\/?wc-ajax=%%endpoint%%",
    ...
    <link rel="canonical" href="https://workscout.in/my-bookmarks/"/>
    <link rel='shortlink' href='https://workscout.in/?p=2565'/>
    <link rel="alternate" type="application/json+oembed"
          href="https://workscout.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fworkscout.in%2Fmy-bookmarks%2F"/>
    <link rel="alternate" type="text/xml+oembed"
          href="https://workscout.in/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fworkscout.in%2Fmy-bookmarks%2F&#038;format=xml"/>
    <style type="text/css">
...
<body class="page-template-default page page-id-2565 logged-in fullwidth group-blog workscout wpb-js-composer js-comp-ver-5.1 vc_responsive">
<div id="wrapper">
                ...
                <nav id="breadcrumbs" xmlns:v="http://rdf.data-vocabulary.org/#">
                    <ul>
                        ...
                        <li class="current_item"><span property="itemListElement" typeof="ListItem"><span
                                property="name">My Bookmarks</span><meta property="position" content="2"></span></li>
                    </ul>
                </nav>
            </div>
        </div>
    ...
    <div class="container full-width">
        <article id="post-2565" class="sixteen columns post-2565 page type-page status-publish hentry">
            <div id="job-manager-bookmarks">
                <table class="manage-table job-manager-bookmarks">
                    <thead>
                    <tr>
                        <th><i class="fa fa-heart"></i> Bookmark</th>
                        <th><i class="fa fa-file-text"></i> Notes</th>
                        <th></th>
                    </tr>
                    </thead>
                    <tbody>
                    ...
                    <tr>
                        <td colspan="3">You currently have no bookmarks</td>
                    </tr>
                    </tbody>
                </table>
            </div>
