...
<head>
    ...
    <script type='text/javascript'>
        ...
        var wc_add_to_cart_params = {
            ...
            "wc_ajax_url": "\/submit-resume\/?wc-ajax=%%endpoint%%",
    ...
    <link rel="alternate" type="application/json+oembed"
          href="../wp-json/oembed/1.0/embed%3Furl=https%253A%252F%252Fworkscout.in%252Fsubmit-resume%252F"/>
    <link rel="alternate" type="text/xml+oembed"
          href="../wp-json/oembed/1.0/embed%3Furl=https%253A%252F%252Fworkscout.in%252Fsubmit-resume%252F&amp;format=xml"/>
    <style type="text/css">
                ...
                <nav id="navigation" class="menu">
                    ...
                    <ul id="responsive" class="menu">
                        ...
                        <li id="menu-item-2855"
                            ...
                            <a href="../index.html%3Fp=13.html#">Pages</a>
                            <ul class="sub-menu">
                        ...
                        <li id="menu-item-2860"
                            ...
                            <a href="/submitResume">Submit Resume</a>
                            <%--<ul class="sub-menu">--%>
                    ...
                    <ul class="float-right">
                        <li><a href="/user_page_candidate"><i class="fa fa-sign-out"></i> User Page</a></li>
                    ...
                    <%--&lt;%&ndash;@declare id="user_email"&ndash;%&gt;<p class="form-row form-row-wide">--%>
                    ...
                    <!-- Spam Trap -->
                    <%--<div  position: absolute;"><label for="trap">Anti-spam</label><input type="text" name="email_2" id="trap" tabindex="-1" /></div>--%>
                    ...
                    <%--</select>--%>
                    <%--<p class="form-row">--%>
                    <%--<input type="hidden" id="_wpnonce" name="_wpnonce" value="523cc9816a" /><input type="hidden" name="_wp_http_referer" value="/submit-resume/" />                    <input type="submit" class="button" name="register" value="Register" />--%>
                    <%--</p>--%>
                    ...
                    <%--<p class="form-row">--%>
                    <%--<input type="hidden" id="_wpnonce" name="_wpnonce" value="8c65a3ecd0" /><input type="hidden" name="_wp_http_referer" value="/submit-resume/" />                    <input type="submit" class="button" name="login" value="Login" />--%>
    ...
    <div class="container full-width">
        <article id="post-13" class="sixteen columns post-13 page type-page status-publish hentry">
            <div class="submit-page">
                <spring:form action="/PreviewResume" modelAttribute="resume" method="post" id="submit-resume-form"
                    ...
                    <%--&lt;%&ndash;<p><span>Have an account?</span>&ndash;%&gt;--%>

                    <%--&lt;%&ndash;If you don&rsquo;t have an account you can create one below by entering your email address. A password will be automatically emailed to you.&ndash;%&gt;--%>
                    <%--&lt;%&ndash;</p>&ndash;%&gt;--%>
                    <%--&lt;%&ndash;<a class="button" href="../index.html%3Fp=19.html">Sign in</a>&ndash;%&gt;--%>
                    <%--</div>--%>
                    ...
                    <fieldset class="form  fieldset-candidate_name">
                        ...
                        <div class="field">
                            <spring:input type="text" class="input-text" name="candidate_name" id="candidate_name"
                                          placeholder="Your full name" value="" maxlength="" required=""
                                          path="candidate_name"/>
                        </div>
                    </fieldset>
                    ...
                    <%--<div class="field">--%>
                    <%--<spring:input type="text" class="input-text" name="candidate_email" id="candidate_email" placeholder="you@yourdomain.com" value="" maxlength="" required="" path="email"/>--%>
                    <%--</div>--%>
                    <%--</fieldset>--%>
                    ...
                    <fieldset class="form  fieldset-candidate_title">
                        ...
                        <div class="field">
                            <spring:input type="text" class="input-text" name="candidate_title" id="candidate_title"
                                          placeholder="e.g. &quot;Web Developer&quot;" value="" maxlength="" required=""
                                          path="title"/>
                        </div>
                    </fieldset>
                    ...
                    <fieldset class="form  fieldset-candidate_location">
                        ...
                        <div class="field">
                            <spring:input type="text" class="input-text" name="candidate_location" id="title"
                                          placeholder="e.g. &quot;London, UK&quot;, &quot;New York&quot;, &quot;Houston, TX&quot;"
                                          value="" maxlength="" required="" path="location"/>
                        </div>
                    </fieldset>
                    ...
                    <%--<div class="field">--%>
                    <%--<spring:input type="text" class="input-text" name="rate_min" id="rate_min" placeholder="e.g. 20" value="" maxlength=""   path="min_rate"/>--%>
                    <%--</div>--%>
                    <%--</fieldset>--%>
                    ...
                    <fieldset class="form  fieldset-resume_category">
                        ...
                        <div class="field">
                            <spring:select name='resume_category[]' id='resume_category'
                                           class='job-manager-category-dropdown ' multiple='multiple'
                                           data-placeholder='Choose a category' data-no_results_text='No results match'
                                           data-multiple_text='Select Some Options' path="category">
                        ...
                        <div class="field">
                            <div id="wp-resume_content-wrap" class="wp-core-ui wp-editor-wrap html-active">
                                ...
                                <div id="wp-resume_content-editor-container" class="wp-editor-container">
                                    <spring:textarea path="content" class="wp-editor-area" rows="8" cols="40"
                                                     name="resume_content" id="resume_content"></spring:textarea></div>
                            </div>
                    ...
                    <fieldset class="form  fieldset-resume_skills">
                        <label for="resume_skills">Skills
                            <small>(optional)</small>
                        </label>
                        <div class="field">
                            <spring:input type="text" class="input-text" name="resume_skills" id="resume_skills"
                                          placeholder="Comma separate a list of relevant skills" value="" maxlength=""
                                          path="skills"/>
                        </div>
                    </fieldset>
                    ...
                    <p class="send-btn-border">
                            <%--<input type="hidden" id="_wpnonce" name="_wpnonce" value="52ad9cefe7" /><input type="hidden" name="_wp_http_referer" value="/submit-resume/" />			<input type="hidden" name="resume_manager_form" value="submit-resume" />--%>
            ...
            <div class="footer-bottom">
                <div class="sixteen columns">
                    ...
                    <ul class="social-icons">
                        <li><a target="_blank" class="facebook" title="Facebook" href="../index.html%3Fp=13.html#"><i
                                class="icon-facebook"></i></a></li>
                        <li><a target="_blank" class="twitter" title="Twitter" href="../index.html%3Fp=13.html#"><i
                                class="icon-twitter"></i></a></li>
                        <li><a target="_blank" class="gplus" title="GooglePlus" href="../index.html%3Fp=13.html#"><i
                                class="icon-gplus"></i></a></li>
                        <li><a target="_blank" class="linkedin" title="LinkdedIn" href="../index.html%3Fp=13.html#"><i
...
<div id="style-switcher">
    ...
    <div>
        <h3>PrefURL(s) defined Colors</h3>
...
<script type='text/javascript'
        src='https://39sf152pf74z2negmt1gi8ik-wpengine.netdna-ssl.com/wp-includes/js/jquery/ui/sortable.min.js'></script>
<script type='text/javascript'>
    /* <![CDATA[ */
    var resume_manager_resume_submission = {
        "i18n_navigate": "If you wish to edit the posted details use the \"edit resume\" button instead, otherwise changes may be lost.",
        "i18n_confirm_remove": "Are you sure you want to remove this item?",
        "i18n_remove": "remove"
    };
    /* ]]> */
</script>
<script type='text/javascript'
        src='https://39sf152pf74z2negmt1gi8ik-wpengine.netdna-ssl.com/wp-content/plugins/wp-job-manager-resumes/assets/js/resume-submission.min.js'></script>
<script type='text/javascript'
